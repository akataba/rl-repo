...
path = "2023-06-09_19-15-06/data-051.txt"
#path = "noiseless_for_paper/data-056.txt"
...
for i in range(2, len(fidelities), 3):
    assert i % 3 == 2, print("mod 3 error")
...
plt.savefig("plots/9x4_ratio_noisy.png")
plt.show()
# --------------------------------------------